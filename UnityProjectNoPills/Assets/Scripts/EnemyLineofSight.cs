...
public class EnemyLineofSight : MonoBehaviour {
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        if(other.gameObject.tag == "Player")
        {
            ...
            hit = Physics2D.Raycast(transform.position, direction1.normalized, 200, whatIsPlayer);
            hitTop = Physics2D.Raycast(transform.position, direction2.normalized, 200, whatIsPlayer);
            hitBot = Physics2D.Raycast(transform.position, direction3.normalized, 200, whatIsPlayer);
